...
namespace UrunKatalog.Mvc_WebSite.Entity
{
    public class DataInitializer:DropCreateDatabaseIfModelChanges<DataContext>
    {
        protected override void Seed(DataContext context)
        {
            ...
            {
                new Product() {Name="Camera",Desription="CameraCameraCameraCameraCamera", Price=1200, Stock=5, IsApproved=true,CategoryId=1, IsHome=true,Image="1.jpg"},
                new Product() {Name="Camera",Desription="CameraCameraCameraCameraCamera", Price=1200, Stock=5, IsApproved=true,CategoryId=1, IsHome=true,Image="2.jpg"},
                new Product() {Name="Camera",Desription="CameraCameraCameraCameraCamera", Price=1200, Stock=5, IsApproved=true,CategoryId=1, IsHome=true,Image="3.jpg"},
